...
class DeepseekV4Model(TextModel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        is_v41 = "V4.1" in model_id_hint
        template_name = ("deepseek-ai-DeepSeek-V4.1-Flash.jinja" if is_v41 else
                         "deepseek-ai-DeepSeek-V4-Flash-0731.jinja" if is_0731 else
